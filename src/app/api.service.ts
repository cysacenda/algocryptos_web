...
export class ApiService {
  ...
  constructor(private http: HttpClient) {
    this.visibleGridColumns = ['crypto_rank', 'coin_name', 'symbol', 'price_usd', 'market_cap_usd', 'percent_change_1h',
  ...
  public getGridColumns(): String[] {
    return ['crypto_rank', 'coin_name', 'symbol', 'price_usd', 'market_cap_usd', 'percent_change_1h',
      'percent_change_24h', 'percent_change_7d',
