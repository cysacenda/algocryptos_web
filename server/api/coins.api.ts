...
export class CoinsApi {
  ...
  public list(req: Request, res: Response, next: NextFunction, pool: Pool) {
    let squery: String = '';
    squery = 'select co."IdCryptoCompare", co."Name", co."Symbol", pr.price_usd, pr.market_cap_usd, pr.rank, pr.percent_change_1h,\n';
    ...
    squery += 'group by co."IdCryptoCompare", co."Name", co."Symbol", pr.price_usd, pr.market_cap_usd, pr.rank, pr.percent_change_1h,\n';
