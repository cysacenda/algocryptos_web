...
export class CoinsApi {
  ...
  public list(req: Request, res: Response, next: NextFunction, pool: Pool) {
    ...
    squery += 'pr.prices_ath_usd, pr.ath_date, (price_usd - prices_ath_usd) / prices_ath_usd as percent_change_ath\n';
    ...
    squery += 'kp.subscribers_30d_trend, kp.subscribers_60d_trend, kp.subscribers_90d_trend, reddit_agr, pr.prices_ath_usd, pr.ath_date\n';
